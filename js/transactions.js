...
.then((respuesta) => {
    ...
    response.forEach(element => {
        ...
        filas += `<tr><td>${element.product}</td><td>${element.total}</td><td>${element.done}</td><td>${element.type}</td><td>
...
function visualizar (goalId)
{
    ...
    .then((respuesta) => {
        ...
        document.getElementById("product").value=respuesta.data.product;
